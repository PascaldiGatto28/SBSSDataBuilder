...
namespace SBSSData.Application.Support
{
    ...
    /// <see cref="PlayerStats"/> and <see cref=="PlayerRank"/> instances whose values are used to populate the record.
    /// </summary>
    ...
    public record PlayerStatsRankDisplay(int Games,
                                         string Name,
                                         int PA,
                                         int AB,
                                         int R,
                                         ...
                                         Rank Ranking)
    {
        ...
        /// <see cref="PlayerStatsRankDisplay"/> record.</param>
        /// /// <param name="playerRank">The <see cref="PlayerRank"/> object whose values are used to initialize the 
        /// <see cref="PlayerStatsRankDisplay"/> record.</param>
        public PlayerStatsRankDisplay(PlayerStats player, Rank playerRank) : this(player.NumGames,
                                                                   player.DisplayName,
