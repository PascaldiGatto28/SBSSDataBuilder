...
namespace SBSSData.Application.Samples
{
    public class Program
    {
        ...
        public static void PlayerSheetsGuide(bool displayHtml = false, bool useCallback = false)
        {
            string seasonText = "2024 Winter";
            string dsFolder = $@"J:\SBSSDataStore\";

            PlayerSheetsGuide playerSheetsGuide = new PlayerSheetsGuide();
            string html = playerSheetsGuide.BuildHtmlPage(seasonText, dsFolder, callback);
        ...
        public static void LogSessions(bool displayHtml = false, bool useCallback = true)
        {
            string seasonText = "2024 Winter";
            string dsFolder = $@"J:\SBSSDataStore\";
        ...
        public static Action<object> callback = (v) => v.Dump();
